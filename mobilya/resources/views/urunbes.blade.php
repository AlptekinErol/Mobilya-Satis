                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="img_box">
                                <figure><img src="assets/images/foto18.jpg" alt="#" /></figure>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 product_detail_side">
                            <div class="abotext_box">
                                ...
                                <div class="product-detail-side">
                                    <span><del>800₺</del></span><span class="new-price">660₺</span>
                                    <span class="rating">
...
Yükseklik: 70 cm
                                    ...
                                    <p>
Yerinden çıkmayı engelleyen mekanizmalı çekmeceler, kolay açılır.

Masif ahşaptan yapılmıştır, dayanıklı ve doğal bir materyaldir.
